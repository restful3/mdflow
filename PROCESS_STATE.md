...
| **Phase M5**. 운영 도구 | **구현 완료·Codex 리뷰 대기** | CLI(`mdflow`), 메트릭(`/capabilities`), CPU Dockerfile, 테스트 매트릭스 문서 (GPU Docker는 M2b 후속) |
...
## 11. Phase M5 — 운영 도구 [구현 완료 — Codex 리뷰 대기]
...
- [x] 286 passed/2 skipped, ruff clean
- [ ] **M5 Codex 묶음 리뷰** → 차단 반영 후 채택 + `v0.6.0-m5` 태그
