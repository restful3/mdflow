...
| **Phase M6**. 이미지 지원 (v2) | **IN PROGRESS** (M6a 시작 — Subagent-Driven 실행) | 9 컨버터 전부에 이미지 추출 + `options.images=none/embed/zip` + canonical+view synthesis 아키텍처. sub M6a (인프라) → M6b (PDF) → M6c (Office) → M6d (HTML/HWP/LO) → M6e (API surface) → M6f (통합+Codex+태그 `v2.0.0-m6`). 스펙 `docs/specs/2026-05-23-m6-image-support-design.md`. plan(M6a) `docs/superpowers/plans/2026-05-23-m6a-image-infrastructure.md` |
