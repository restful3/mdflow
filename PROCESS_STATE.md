...
| **Phase M0**. 골격 (skeleton) | **IN PROGRESS** (13/17 + Codex 리뷰 진행) | `pyproject.toml`, `mdflow.core`, `Converter` Protocol, txt/md/csv passthrough, URL fetch helper, ConversionService, `/healthz` |
...
## 6. Phase M0 — 골격 (skeleton) [IN PROGRESS]
