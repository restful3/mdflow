...
- [ ] **M0 Task 12\~17 진행**: `url_fetch`(12, 합의안 §3.2의 10단계 직접 반영) → `ConversionService`(13) → FastAPI `/healthz`(14) → admin endpoints(15) → smoke test(16) → 태그(17)
